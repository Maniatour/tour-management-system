...
export default function ProductDetailMobileStickyCta({
  ...
  return (
    <div
      className="fixed bottom-[var(--footer-height)] left-0 right-0 z-50 border-t border-slate-200 bg-white/95 px-4 py-3 shadow-[0_-8px_30px_rgba(15,23,42,0.12)] backdrop-blur-md lg:hidden"
      role="region"
