                  ...
                  <div className="space-y-1.5">
                    ...
                    {mismatchRows.map((row) => (
                      ...
                      <div
                        ...
                        className="rounded-md border border-orange-200/80 bg-white/80 p-1.5"
                  ...
                  <div className="space-y-1.5">
                    ...
                    {cancelDueRows.map((row) => (
                      ...
                      <div
                        ...
                        className="rounded-md border border-red-200/80 bg-red-50/30 p-1.5"
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-0.5 flex flex-wrap items-center gap-1">
                              ...
                              <span className="rounded border border-red-300 bg-red-100 px-1 py-0.5 text-[9px] font-bold tabular-nums text-red-900">
                                ...
                                {isKo ? '취소 요청' : 'Cancel'} {row.cancel_from} → {row.cancel_to}
