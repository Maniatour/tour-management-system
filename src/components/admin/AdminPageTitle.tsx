...
const FALLBACK_TITLES: Record<string, { ko: string; en: string }> = {
  ...
  'sidebar.tourPhotos': { ko: '전체 투어 사진', en: 'All Tour Photos' },
  ...
  'sidebar.groupProducts': { ko: '상품', en: 'Products' },
  'sidebar.groupSales': { ko: '판매', en: 'Sales' },
  'sidebar.groupOperations': { ko: '운영', en: 'Operations' },
  'sidebar.groupTeam': { ko: '팀', en: 'Team' },
  'sidebar.groupSuppliers': { ko: '공급사', en: 'Suppliers' },
  'sidebar.groupFinance': { ko: '재무', en: 'Finance' },
  'sidebar.groupData': { ko: '데이터', en: 'Data' },
  'sidebar.groupSystem': { ko: '시스템', en: 'System' },
  // 헤더 빠른 이동
