 ...
 */
export default function SopPrintPreviewFrame({ doc, viewLang, caption, signatureNote }: Props) {
  return (
    <div className="rounded-lg border border-slate-300 bg-slate-100/80 p-3 shadow-inner">
      ...
      <div
        className="rounded border border-slate-200 bg-slate-200/50 shadow-inner overflow-x-auto overflow-y-auto"
