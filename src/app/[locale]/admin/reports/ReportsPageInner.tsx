...
const ReservationReportTab = dynamic(() => import('@/components/reports/ReservationReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={10} />,
})
const TourReportTab = dynamic(() => import('@/components/reports/TourReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={8} />,
})
const ExpenseReportTab = dynamic(() => import('@/components/reports/ExpenseReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={8} />,
})
const DepositReportTab = dynamic(() => import('@/components/reports/DepositReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={8} />,
})
const SettlementReportTab = dynamic(() => import('@/components/reports/SettlementReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={8} />,
})
const CashReportTab = dynamic(() => import('@/components/reports/CashReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={8} />,
})
const PnlUnifiedReportTab = dynamic(() => import('@/components/reports/PnlUnifiedReportTab'), {
  loading: () => <AdminPageContentSkeleton rows={12} />,
})
const EmailScheduleModal = dynamic(() => import('@/components/reports/EmailScheduleModal'), {
  ssr: false,
  loading: () => null,
})
...
export default function AdminReports() {
  ...
  const reservationTabLoading =
    needsFullReservationDataset && loading && (activeTab === 'comprehensive' || activeTab === 'reservations')
  ...
  if (isCheckingPermission) {
    return <AdminPageLoadingSkeleton label="통계 리포트 권한 확인 중..." />
  }
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-[1920px] mx-auto px-3 sm:px-4 min-w-0 overflow-x-hidden pb-[max(1.5rem,env(safe-area-inset-bottom,0px))]">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-5 lg:p-6 min-w-0">
        {reservationTabLoading ? (
          <AdminPageContentSkeleton rows={10} />
        ) : (
          <>
