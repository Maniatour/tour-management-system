...
const ReservationExpenseTabPanel = dynamic(
  () => import('@/components/expenses/ReservationExpenseTabPanel'),
  { loading: () => <AdminPageContentSkeleton rows={8} /> }
)
const ReservationOptionsHistoryTab = dynamic(
  () => import('@/components/expenses/ReservationOptionsHistoryTab'),
  { loading: () => <AdminPageContentSkeleton rows={8} /> }
)
const CompanyExpenseManager = dynamic(() => import('@/components/CompanyExpenseManager'), {
  loading: () => <AdminPageContentSkeleton rows={10} />,
})
const AllTourExpensesManager = dynamic(() => import('@/components/AllTourExpensesManager'), {
  loading: () => <AdminPageContentSkeleton rows={10} />,
})
const CashManagement = dynamic(() => import('@/components/CashManagement'), {
  loading: () => <AdminPageContentSkeleton rows={10} />,
})
const CategoryManagerModal = dynamic(() => import('@/components/expenses/CategoryManagerModal'), {
  ssr: false,
  loading: () => null,
})
const CompanyExpenseDuplicateCheckModal = dynamic(
  () => import('@/components/reconciliation/CompanyExpenseDuplicateCheckModal'),
  { ssr: false, loading: () => null }
)
const DeletedUnifiedExpensesModal = dynamic(
