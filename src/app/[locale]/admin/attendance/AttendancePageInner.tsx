...
const OfficeTipsModal = dynamic(() => import('@/components/attendance/OfficeTipsModal'), {
  ssr: false,
  loading: () => null,
})
const BiweeklyCalculatorModal = dynamic(() => import('@/components/BiweeklyCalculatorModal'), {
  ssr: false,
  loading: () => null,
})
const TotalEmployeesModal = dynamic(() => import('@/components/TotalEmployeesModal'), {
  ssr: false,
  loading: () => null,
})
const EmployeeHourlyRatesModal = dynamic(() => import('@/components/attendance/EmployeeHourlyRatesModal'), {
  ssr: false,
  loading: () => null,
})
const TipsShareModal = dynamic(() => import('@/components/TipsShareModal'), {
  ssr: false,
  loading: () => null,
})
