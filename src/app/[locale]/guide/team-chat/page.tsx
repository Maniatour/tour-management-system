...
import { MessageCircle, Plus, Pin, Search, RefreshCw } from 'lucide-react'
...
export default function GuideTeamChatPage() {
  ...
  return (
    <div className="flex h-[90vh] bg-white">
      {/* 왼쪽: 채팅방 목록 */}
      <div className={`${selectedRoom ? 'hidden lg:flex' : 'flex'} lg:w-80 w-full bg-white border-r border-gray-200 flex-col`}>
        {/* 헤더 */}
