...
> = {
  ...
  'commerce/ota-mappings': { readGate: 'canViewAdmin', manage: 'canManageChannels' },
  'operator-b/manual': { readGate: 'canViewAdmin', manage: 'canViewAdmin' },
  operators: { readGate: 'canViewAdmin', manage: 'canManageTeam' },
