...
export function defaultKnowledgeArticleSeeds(): ArticleSeed[] {
  return [
    ...
    seed(
      ...
      '별점 포인트·$5·월 1~말일 고객 후기 등록일 기준·16~말일 2주급 지급',
      'Star points, $5 each, calendar month by guest review date, paid on 16th–end payroll',
      'guide',
      'regulation',
      ['guide', 'driver'],
      50,
      doc('후기 포인트', 'Review bonus points', [
        sec('제도 안내', 'Policy', 0, [
          ...
          cat(
            ...
            1,
            checks([
              { ko: '후기는 고객이 남긴 날짜 기준으로 해당 월에 집계됨을 이해', en: 'Reviews count by the guest posted date in that calendar month' },
    ...
    seed(
      ...
      '월 1~말일 고객 후기 등록일 집계, 16~말일 2주급에 $5/포인트 반영',
      'Count reviews by guest posted date (1st–last day); pay $5/point on 16th–end payroll',
      'office',
      'playbook',
      ['office', 'office manager'],
      30,
