...
export const ADMIN_TODO_LIST_HUB_ARTICLE_META = {
  ...
  summary_ko:
    '업무 Todo·업무 관리 플로팅 위젯, 일일 고정 패널 15종, 완료/보류, 알림, 가이드 스케줄 컨펌, 사이트 알림까지 이번 개편 내용을 정리한 운영 매뉴얼입니다.',
  summary_en:
  ...
  const sections: SopSection[] = [
    {
      ...
      content_ko: [
        ...
        '- **업무 Todo** (초록색): 일일 체크리스트 · 고정 업무 패널 15종',
        '',
      ...
      content_en: [
        ...
        '- **Work Todos** (green): daily checklist · 15 built-in work panels',
        '',
    ...
    },
    {
      ...
      content_ko: [
        ...
        '- 큐가 비면 패널 **자동 완료**. 고객 정보 검수·취소 재예약 등 라이브 패널은 새 건이 생기면 **자동 미완료**',
