...
export const CUSTOMER_PAGE_ZONE_EDIT_MAP: Record<CustomerPageZone, ZoneEditConfig> = {
  ...
  'home-hero': {
    ...
    translationFields: [
      ...
      { key: 'homeHeroStatReviewsFull', label: '리뷰 통계' },
      { key: 'homeHeroStatTravelersFull', label: '여행자 통계' },
      { key: 'homeHeroStatSmallGroupFull', label: '소그룹 통계' },
      { key: 'homeHeroStatSinceFull', label: '경력 통계' },
