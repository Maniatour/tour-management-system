    ...
    <div className="bg-gray-50 px-2 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-200">
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3 flex-1 min-w-0">
          ...
          <p className="text-[11px] sm:text-sm font-medium text-gray-800 pl-4 sm:pl-0 sm:ml-0 leading-snug break-words">
            {activitySummary}
          </p>
        </div>
...
Path("src/components/reservation/DateGroupHeader.tsx").write_text(content, encoding="utf-8")
print("wrote DateGroupHeader")
