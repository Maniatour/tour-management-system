-- get_schedule_display: tours JSON에 antelope_check_in_date 포함 (숙박투어 입장권 인원 대조일)
...
COMMENT ON FUNCTION public.get_schedule_display(uuid, date, date, date, date) IS
  'Schedule view payload; tours include antelope_check_in_date for lodging ticket pax compare.';
